module github.com/aegoens/gorm-opentelemetry
...
require (
	...
	go.opentelemetry.io/contrib/propagators/opencensus v0.36.2
...
require (
	...
	go.opentelemetry.io/otel/bridge/opencensus v0.32.2 // indirect
